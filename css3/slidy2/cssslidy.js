var cssSlidy = function(newOptions) {
	var options = (function() {
		...
		CS.init = (function() {
			...
			if (CS.element.style.animationName !== undefined) {
			...
			if (CS.hasAnimation === true) {
				...
				while (L) {
					...
					who = images[--L];
					// wraps all images in the slider with figure elements
		...
		// set the width and size of the inner <figure> elements
